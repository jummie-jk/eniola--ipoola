        ...
        <div>
           ...
           <section className="section">
             <div className="homepage-intro-div">
                <div>
                    <p  className="intro-text">Hello, I’m <br /> Eniola Ipoola.</p>
                    <div className="home-contact-div">
                        ...
                        <div> <a href="https://www.linkedin.com/in/eniolaipoola" target="_blank"><img src={linkedln} alt="Icon" /></a></div>
                        <div> <a href="https://github.com/eniolaipoola" target="_blank"><img src={github} alt="Icon" /></a></div>
                    </div>
                </div>
                <div>
                    <p className="intro-mini">I am an Android Engineer keen to build scalable Android products <br/> that meet business goals and satisfy users' needs.</p>
